...
public class AddNewSupplier extends JFrame implements ActionListener
{
    ...
    JScrollPane scrlPane = new JScrollPane(tabGrid); //it created when data presented
	...
	//	jf.add(t1);
		...
		t5.setBounds(320,280,200,25);t5.setToolTipText("Enter supplier email ");
		jf.add(t5);
	...
	if(ae.getSource()==b0)
	 {
            ...
            ps=con.prepareStatement("insert into supplier (sname,saddress,sphoneno,semailid)values(?,?,?,?)");// called (labeled "?")
