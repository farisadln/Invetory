...
class Login extends JFrame implements ActionListener
{
	...
	Login()
	{
		...
		l3 = new JLabel(new ImageIcon("src\\images\\users.png"));
        ...
        l4 = new JLabel(new ImageIcon("src\\images\\pass.png"));
		...
		b1 = new JButton("Login",new ImageIcon("src\\images\\Login.png"));
		...
		b3 = new JButton("Exit",new ImageIcon("src\\images\\exit.png"));
	...
	public void actionPerformed(ActionEvent ae)
	{
		if(ae.getSource()==b1)
		{
			try
			{
				...
				if((s.compareTo("admin")==0)&&(s1.compareTo("admin")==0) ||(s.compareTo("admin2")==0)&&(s1.compareTo("admin2")==0) )
				{
