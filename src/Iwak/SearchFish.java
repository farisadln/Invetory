...
public class SearchFish extends JFrame implements ActionListener
{
  ...
  l1.setBounds(50,100,200,25);
		...
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter Fish batch no to search");
		jf.add(t1);
   ...
   l2.setBounds(50,140,200,25);
		...
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter Fish name to search");
		jf.add(t2);
   ...
   l11.setBounds(470,260,180,25);
 	...
 	l12.setBounds(470,300,180,25);
        ...
        b0 = new JButton("Search",new ImageIcon("src\\images\\search.png"));
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to search Fish details");
