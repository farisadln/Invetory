...
public class DeleteFish extends JFrame implements ActionListener
{
	JFrame jf;
...
l1.setBounds(50,100,200,25);
		...
		t1.setBounds(250,100,100,25);t1.setToolTipText("Enter Fish batch no to delete Fish");
		jf.add(t1);
  ...
  l2.setBounds(50,140,200,25);
		...
		t2.setBounds(250,140,200,25);t2.setToolTipText("Enter Fish name to delete Fish");
		jf.add(t2);
  ...
  l9.setBounds(470,180,200,25);
   ...
   l11.setBounds(470,260,180,25);
       ...
       l12.setBounds(470,300,180,25);
		...
		b1 = new JButton("Delete",new ImageIcon("src\\images\\delete.png"));
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to delete Fish details");
    	...
    	b3 = new JButton("All",new ImageIcon("src\\images\\all.png"));//if button is press then record display repeat
    ...
    if(ae.getSource()==b0)
	  {
	  	try
	  	{
	  	 if(((t1.getText()).equals(""))&&((t2.getText()).equals("")))
	        {
		    JOptionPane.showMessageDialog(this,"Please enter Fish bno or name !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
	         int foundrec = 0;
	 ...
	 {//delete
		...
		con=DriverManager.getConnection("jdbc:mysql://localhost:3306/iwak_store","root","root");
		System.out.println("Connected to database.");
	    ps=con.prepareStatement("delete from fish where mbno='"+t1.getText()+"' or mname='"+t2.getText()+"'");
	    ps.executeUpdate();
