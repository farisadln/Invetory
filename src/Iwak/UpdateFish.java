...
public class UpdateFish extends JFrame implements ActionListener
{
	JFrame jf;
  ...
  l3.setBounds(50,180,200,25);
		...
		t3.setBounds(250,180,200,25);t3.setToolTipText("Enter Fish company");
		jf.add(t3);
  ...
  l7.setBounds(470,100,200,25);
		...
		t7.setBounds(720,100,100,25);t7.setToolTipText("Enter Fish type");
		jf.add(t7);

    	tabtype=new JComboBox();
        tabtype.addItem("--type--");
		tabtype.addItem("Sea Fish");
		tabtype.addItem("Fresh Fish");
		tabtype.addItem("Brackish Fish");
		tabtype.setBounds(600,100,100,25);tabtype.setToolTipText("Select Fish type");
		jf.add(tabtype);
...
l10.setBounds(470,220,200,25);
 ...
 l12.setBounds(470,300,180,25);
        ...
        msname.setBounds(600,260,110,25);msname.setToolTipText("select Fish supplier name");
        jf.add(msname);
       ...
       System.out.println(e);
        ...
        b0 = new JButton("Open",new ImageIcon("src\\images\\open.png"));
        b0.setBounds(150,330,110,35);b0.setToolTipText("click to open Fish details");
		jf.add(b0);b0.addActionListener(this);

		b1 = new JButton("Update",new ImageIcon("src\\images\\update.png"));
		b1.setBounds(300,330,110,35);b1.setToolTipText("click to update Fish details");
	    jf.add(b1); b1.addActionListener(this);

        b2= new JButton("Clear",new ImageIcon("src\\images\\clear.png"));
		b2.setBounds(450,330,110,35);b2.setToolTipText("click to clear all textfields");
		jf.add(b2); b2.addActionListener(this);

    	b3 = new JButton("All",new ImageIcon("src\\images\\all.png"));
		b3.setBounds(600,330,110,35);b3.setToolTipText("click to view all Fish details");
 ...
 public void actionPerformed(ActionEvent ae)
  {
  	if(ae.getSource()==b0)
	  {
	        ...
	        {
		    JOptionPane.showMessageDialog(this,"Please enter Fish batchno or name !","Warning!!!",JOptionPane.WARNING_MESSAGE);
	        }
	        else
	        {
		...
		System.out.println("Connected to database.");
		  ...
		  ps=con.prepareStatement("select * from fish where mname='"+t2.getText()+"' or mbno='"+t1.getText()+"' ");
		  rs=ps.executeQuery();
		  while(rs.next())
	      {
...
String str1="UPDATE fish SET mbno='"+t1.getText()+"',mname='"+t2.getText()+"',mcompany='"+t3.getText()+"',mqty='"+t4.getText()+"',mexpdate='"+t5.getText()+"',mpurdate='"+t6.getText()+"',mtype='"+t7.getText()+"',mpurprice='"+t8.getText()+"',msaleprice='"+t9.getText()+"',mrackno='"+t10.getText()+"',sid='"+t12.getText()+"',sname='"+t11.getText()+"' where mbno='"+t1.getText()+"'or mname='"+t2.getText()+"'";
