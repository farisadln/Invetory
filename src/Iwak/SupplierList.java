...
public class SupplierList extends JFrame
 {
    ...
    JLabel ln;
    Connection con;
    PreparedStatement ps;//supply values in place of the question mark placeholders
    Statement stmt;//signals the driver that the auto-generated keys indicated in the given array should be made available for retrieval.
    ResultSet rs;
